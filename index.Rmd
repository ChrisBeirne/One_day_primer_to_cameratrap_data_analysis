...
This is an abridged version of the full three day course located here: [An Introduction to Camera Trap Data Management and Analysis in R](https://wildcolab.github.io/Introduction-to-Camera-Trap-Data-Management-and-Analysis-in-R/). That version will be the most up-to-date and comprehensive.  

## How to use this book

You can run this code to get a quick flavour for camera trap data analysis. 
